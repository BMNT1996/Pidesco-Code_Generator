...
import pt.iscte.pidesco.codegenerator.internal.SimpleCode;
/**
...
public interface CodeGeneratorServices {
	 ...
	 * @param file Java source file where exists attributes to be generated its getters and setters
	 * @param Getters List of attributes names that will be generated the getters
	 * @param Setters List of attributes names that will be generated the setters
	 */
	 ...
	 * @param Getters List of attributes names that will be generated the getters
	 * @param Setters List of List of attributes names that will be generated the getters
	 */
	void generateGettersAndSettersFromArrayList(ArrayList<CGAttribute> atributes, ArrayList<String> Getters, ArrayList<String> Setters);
	 ...
	 * @param Class CGClass of the class that contains the information to generate the toString
	 * @param Attributes List of attributes names that will be included in toString
	 * @param Methods List of methods names that will be included in toString
	 */
