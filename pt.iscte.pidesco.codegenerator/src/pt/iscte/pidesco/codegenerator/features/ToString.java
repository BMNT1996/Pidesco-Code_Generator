...
public class ToString extends ComplexCode {
	...
	public static void generateToStringFromArrayList(File file, ArrayList<String> Attributes, ArrayList<String> Methods) {
		generateToStringFromArrayList(CG_AST_Processing.GenerateCGClass(file), Attributes, Methods);
	}
	
	public static void generateToStringFromArrayList(CGClass Class, ArrayList<String> Attributes, ArrayList<String> Methods) {
		String output="	@Override" + System.lineSeparator() + "	public String toString() {" + System.lineSeparator() + "		return \"" + Class.getClassName()+"\" + System.lineSeparator() + \"\tAttributes:\" + System.lineSeparator() ";
